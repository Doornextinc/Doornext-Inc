...
export default function DriverOrderDetailPage() {
  ...
  const statusColor = isFailed ? 'text-error' : 'text-neighborhood-green'
  ...
  return (
    <div className="flex flex-col min-h-full bg-background pb-6">
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Status + date */}
        <div className="bg-surface-container rounded-2xl border border-outline-variant/30 px-4 py-4">
        ...
        <div className="bg-surface-container rounded-2xl border border-outline-variant/30 px-4 py-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xs font-black text-on-surface uppercase tracking-wide">Your Earnings</h2>
          </div>
          <div className="space-y-1.5 text-sm">
            ...
            {tip > 0 && (
              <div className="flex justify-between text-neighborhood-green font-semibold">
                <span>Tip</span>
          ...
          <div className="mt-3 pt-3 border-t border-outline-variant/30 flex justify-between">
            ...
            <span className="font-black text-primary text-lg">${earn.toFixed(2)}</span>
          </div>
        </div>
        ...
        <div className="bg-surface-container rounded-2xl border border-outline-variant/30 px-4 py-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-xs font-black text-on-surface uppercase tracking-wide">Picked Up From</h2>
          </div>
        ...
        {addr && (
          <div className="bg-surface-container rounded-2xl border border-outline-variant/30 px-4 py-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-xs font-black text-on-surface uppercase tracking-wide">Delivered To</h2>
            </div>
            ...
            {addr.label && (
              <p className="text-xs text-outline mt-0.5 italic">{addr.label}</p>
            )}
          </div>
        )}
        ...
        {order.dropoff_note && (
          <div className="bg-surface-container rounded-2xl border border-outline-variant/30 px-4 py-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-xs font-black text-on-surface uppercase tracking-wide">Drop-off Instructions</h2>
            </div>
            <p className="text-sm text-on-surface leading-relaxed">{order.dropoff_note}</p>
          </div>
        )}
        ...
        {order.order_items.length > 0 && (
          <div className="bg-surface-container rounded-2xl border border-outline-variant/30 overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3.5 border-b border-outline-variant/30">
              <Package size={15} className="text-primary" />
              <h2 className="text-xs font-black text-on-surface uppercase tracking-wide">
                Items Delivered
              </h2>
            </div>
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-outline-variant/30">
              ...
              <span className="text-sm font-bold text-on-surface">${order.total.toFixed(2)}</span>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center justify-center gap-2 py-2">
          ...
          <p className="text-[11px] text-outline font-mono">{order.id}</p>
        </div>
